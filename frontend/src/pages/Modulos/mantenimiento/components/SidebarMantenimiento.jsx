import {
  LayoutDashboard, FolderKanban, LogOut, Menu, X, MapPin, Package
} from "lucide-react";
import logoEmpresa from '../../../../assets/logo-pyn.png';
import { useState } from "react";

export default function SidebarMantenimiento({
  menuActivo,
  setMenuActivo,
  cerrarSesion
}) {
  ...
  // Leemos el usuario del módulo de mantenimiento
  const usuario = JSON.parse(localStorage.getItem("mantenimientoUser")) || {};
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          ...
          {/* Aquí puedes dejar los otros menús si los necesitas */}
          <MenuButton menu="ubicacion" icon={MapPin} label="Ubicaciones" />
          <MenuButton menu="activos" icon={Package} label="Activos" />
        </div>
